...
namespace Lab_Refactoring
{
        ...
        public decimal ApplyDiscount(decimal price, AccountStatus accountStatus, int timeOfHavingAccountInYears)
        {
            ...
            switch (accountStatus)
            {
                ...
                case AccountStatus.MostValuableCustomer:
                    ...
                    break;
                default:
                    throw new NotImplementedException("Unknown account status: " + accountStatus.ToString());
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            decimal priceAfterDiscount = 10000m;
            priceAfterDiscount = discountManager.ApplyDiscount(priceAfterDiscount, AccountStatus.MostValuableCustomer, 5);
            Console.WriteLine("Price after discout: " + priceAfterDiscount);
        }
    }
}